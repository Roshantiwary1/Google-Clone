  ...
  return (
    <form className="flex flex-col items-center mt-7" onSubmit={searchHandler} >
        ...
        <div className="flex whitespace-nowrap items-center flex-row w-[50%] space-y-2 mt-2 sm:mt-8 sm:space-y-0 space-x-2 sm:space-x-4 justify-center">
          <button type="submit" className=" bg-[#f8f9fa] font-medium p-3 rounded-md text-sm text-gray-700 hover:ring-1 text-center hover:ring-gray-200 focus:outline-none active:ring-gray-300 hover:shadow-md">Google Search</button>
          <button className=" bg-[#f8f9fa] font-medium pt-3 px-3 sm:pb-3 pb-[21px]  rounded-md text-sm text-gray-700 hover:ring-1 hover:ring-gray-200 focus:outline-none text-center active:ring-gray-300 hover:shadow-md">I&apos;m Feeling Lucky</button>
        </div>
    </form>
  )
}
